...
export const metadata: Metadata = { title: "Closings" };
...
export default async function ClosingsPage({
  ...
  const result = await listDealsByStage(context, "CLOSING", {
    search: params.q,
  ...
  return (
    <>
      <PageHeader
        title="Closings"
        subtitle="The final stage. Closing a deal creates the sale and freezes its commission - it cannot be undone."
      />
      ...
      <div className="card">
        ...
        {result.rows.length === 0 ? (
          <EmptyState
            ...
            message="Deals arrive here once verification is successful."
          />
        ) : (
